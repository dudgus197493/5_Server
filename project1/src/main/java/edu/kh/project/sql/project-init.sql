...
COMMENT ON COLUMN "MEMBER"."PROFILE_IMG" IS '프로필 이미지 경로 (NULL 일 때 기본 이미지)';
...
COMMENT ON COLUMN "BOARD"."B_UPDATE_DATE" IS '게시글 마지막 수정일(수정 시 UPDATE)';
...
COMMENT ON COLUMN "COMMENT"."MEMBER_NO" IS '댓글을 작성한 회원 번호';
