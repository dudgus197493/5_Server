...
<body>
    ...
    <pre>
        Servlet/JSP에는 기본적으로 내장되어있는 4가지 객체 존잰
        ...
        *****************************
        ...
        -> setAttribute("key, value")로 내장 객체가 값을 세팅할 떼
           key 값이 중복되는 경우
           
           \{key} 로 작성하는 경우 범위가 작은 내장 객체가 높은 우선순위를 가짐
