...
<body>
	...
	<pre>
		...
		3) 객체에 저장된 값을 얻어올 때 getter를 호출
		   get필드명()이 아닌 필드명만 작성 
		 
		4) 데이터 파싱(String -> int)도 자동으로 된다
	</pre>

	메세지 : ${message } <br>
	preson의 name : ${person.name }<br>
    ...
    <h4>\${값 == null } / \${ 값 eq null} : null 인지 검사 방법</h4>

    <h4>\${값 != null } / \${ 값 ne null} : null 아닌지 검사 방법</h4>
